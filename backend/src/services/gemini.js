...
- styleTips: 2–4 tips purely about improving the style itself — fit, proportions, color harmony, pattern mixing, layering. Each starts with an action verb. If the user has wardrobe items that would improve the outfit, PRIORITIZE referencing those specific owned pieces first (e.g. "Swap the black tee for your white baggy T-shirt"). You may also suggest new pieces the user doesn't own when relevant.
